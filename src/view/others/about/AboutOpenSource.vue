...
<template>
  <div class="About-Container LayoutSub-Frame">
    <h3 style="text-align: center">TalexWiki 开源协议</h3>
    <blockquote>
      本项目主体以 Apache License 2.0 进行开源，更多信息见下：
    </blockquote>
    <div class="content">
      <hr class="thin">
      ...
      <h3 style="text-align: center;">
        <a href="http://www.apache.org/licenses/" target="_blank">Apache License 2.0 (Jan, 2004)</a>
      </h3>
